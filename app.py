...
def cost_splitter_app():
    ...
    st.divider()
    st.caption("⚙️ Created to automate and fix the tedious manual entry process.")
    st.caption("💡 Originally built by Hitanshu Shah, Amit Prajapati, and Darsh Chandura.")
